...
while continuer:
        ...
        if choix == 1:
                ...
                ether = Objet("ressource\ether.png",etherposition[0],etherposition[1])

                nombreAléatoire2 = random.randint(1,108)
                seringueposition = niveau.case(nombreAléatoire2)
                seringue = Objet("ressource\seringue.png",seringueposition[0],seringueposition[1])

                nombreAléatoire3 = random.randint(1,108)
                armeposition = niveau.case(nombreAléatoire3)
                arme = Objet("ressource/arme.png",armeposition[0],armeposition[1])
