...
while continuer:
    ...
    if choose == 1:
        ...
        nombreAleatoire1 = random.randint(1, 108)
        etherposition = Level_ingame.random(nombreAleatoire1)
        ether = Objet(etherObj, etherposition[0], etherposition[1])
        nombreAleatoire2 = random.randint(1, 108)
        syringeposition = Level_ingame.random(nombreAleatoire2)
        syringe = Objet(seringueObj, syringeposition[0], syringeposition[1])
        nombreAleatoire3 = random.randint(1, 108)
        weaponposition = Level_ingame.random(nombreAleatoire3)
        weapon = Objet(armeObj, weaponposition[0], weaponposition[1])
        mc = character(perso_down, perso_front, perso_left
                       , perso_right, Level_ingame)
